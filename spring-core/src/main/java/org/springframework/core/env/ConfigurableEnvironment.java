...
/**
 * 作用：1.设置活动的和默认的 profile
 *       2.操作底层属性源（通过 ConfigurablePropertyResolver 接口）
 *
 * Configuration 被大多数 Environment 类型实现。
 * 提供设置活动的和默认的 profile，操作底层属性源的工具。
 * 允许客户端设置和验证需要的属性，定制转换服务和 ConfigurablePropertyResolver 的功能
 *
