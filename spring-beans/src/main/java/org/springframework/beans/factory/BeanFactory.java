 ...
 *
 * 这种方法的重点是 BeanFactory 是应用程序组件的中央注册表，
 * 并集中应用程序组件的配置（例如，不再需要单个对象读取属性文件）。
 ...
 *
 * 通常，BeanFactory 将加载存储在配置源（例如XML文档）中的 bean definition，
 ...
 *
 * 与{@link ListableBeanFactory}中的方法相反，如果这是{@link HierarchicalBeanFactory}，
